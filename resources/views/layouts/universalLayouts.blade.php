                    ...
                    <div class="navbar-expand-md col-md-3 col-lg-2 d-flex flex-column">
                        ...
                        @auth
                            @if (Auth::user()->is_admin == 1)
                                <nav id="sidebarMenu" class="bg-white pb-3 px-2 my-2 d-md-block bg-light sidebar collapse navbar-collapse rounded shadow-lg"
                                    ...
                                    <div class="position-sticky pt-3 mx-auto">
                                            ...
                                            <div>
                                                ...
                                                <li class="{{ active('dashboard/projects') }} nav-item">
                                                    <a class="nav-link text-black text-left" href="/dashboard/projects">
                                                        <span class="me-5 pe-2 align-text-bottom">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="30"
                                                                height="30" fill="currentColor" class="bi bi-card-checklist"
                                                                viewBox="0 0 16 16">
                                                                <path
                                                ...
                                                <li class="{{ active('dashboard/employees') }} nav-item">
                                                    <a class="nav-link text-black text-left" href="/dashboard/employees">
                                                        <span class="me-5 pe-2 align-text-bottom">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="30"
                                                                height="30" fill="currentColor" class="bi bi-person"
                                                                viewBox="0 0 16 16">
                                                                <path
                                                ...
                                                <li class="{{ active('dashboard/jobs') }} nav-item">
                                                    <a class="nav-link text-black text-left" href="/dashboard/jobs">
                                                        <span class="me-5 pe-2 align-text-bottom">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="30"
                                                                height="30" fill="currentColor" class="bi bi-briefcase"
                                                                viewBox="0 0 16 16">
                                                                <path
                                        ...
                                        <ul class="nav flex-column pt-5">
                                            ...
                                            <div>
                                                ...
                                                {{-- <li class="{{ active('dashboard/mails') }} nav-item">
                                                <a class="nav-link text-black text-left text-muted " href="/dashboard/mails">
                                                    Maily
                                                </a>
                                            </li> --}}
                                            </div>
                                ...
                                <nav id="sidebarMenu" class="bg-white pb-3 px-2 my-2 d-md-block bg-light sidebar collapse navbar-collapse rounded shadow-lg"
                                    ...
                                    <div class="position-sticky pt-3">
                                        <ul class="nav flex-column ">
                                            ...
                                            <div>
                                                <li class="{{ active('employee/*/profile') }} nav-item mt-2 ">
                                                    <a class=" nav-link text-black text-left "
                                                        href="/employee/{{ Auth::user()->id }}/profile">
                                                        <span data-feather="home" class="align-text-bottom"></span>
                                                        Dashboard
                                                    </a>
                                                </li>
                                                ...
                                                <li class="{{ active('dashboard/activity') }} nav-item">
                                                    <a class="nav-link text-black text-left text-muted "
                                                        href="/employee/{{ Auth::user()->id }}/show">
                                                        smazat
                                                    </a>
                                                </li>
                                        ...
                                        <ul class="nav flex-column pt-5 ">
                                            ...
                                            <div>
                                                <li class="{{ active('employee/*/records') }} nav-item mt-2">
                                                    <a class="nav-link text-black text-left"
