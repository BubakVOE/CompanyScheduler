    ...
    <div class="container py-3">
        ...
        <main>
            <div class="row row-cols-1 row-cols-md-3 mb-3 text-center">
                        ...
                        <div class="card-body d-flex justify-content-center align-items-center">
                            ...
                            <button type="button" class="btn btn-outline-none" data-bs-toggle="modal"
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="150" height="150"
                                    fill="currentColor" class="bi bi-plus-square btn-success " viewBox="0 0 16 16">
                                    <path
                ...
                <template v-for="project in company_relations.projects">
                    <div class="col mb-4 ">
                        <div class="h-100 card rounded-3 shadow-sm rounded border-success">
                    ...
                    <div class="modal-body p-5 col-10 container">
                        ...
                        <div class="d-flex justify-content-around">
                            <div class="form-floating">
                                <input type="text" class="form-control" id="floatingPassword" placeholder="59 30"
                                    v-model="project_create.address_latitude" />
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="floatingPassword" placeholder="60 39"
                                    v-model="project_create.address_longitude" />
                                <label for="floatingPassword">
                                    address_longitude
                                </label>
                            </div>
...
<script>
    export default {
        ...
        mounted() {
            this.project_create.company_id = this.company_relations.id
        },
