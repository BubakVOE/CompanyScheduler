                ...
                <form @submit.prevent="createNewJob" class='container col-10'>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-4">
                                <div class="form-outline">
                                    ...
                                    <input v-model="form.hours" type="number" class="form-control text-center"
                                        aria-describedby="hoursPerDay" placeholder="8" step="0.1">

                                    <template v-if="add_errors.hours">
                                        <p v-for="error in add_errors.hours"
                            ...
                            <div class="col-md-6 mb-4">
                                <div class="form-outline">
                                    ...
                                    <template v-if="add_errors.money_per_hour">
                                        <p v-for="error in add_errors.money_per_hour"
                                            class="alert alert-danger d-flex align-items-center" role="alert">
                                            {{ error }}
                                        </p>
                                    </template>
                        ...
                        <div class='mb-3 col-10 container'>
                            ...
                            <template v-if="add_errors.project">
                                <p v-for="error in add_errors.project"
                                    class="alert alert-danger d-flex align-items-center" role="alert">
                                    {{ error }}
                                </p>
                            </template>
                        ...
                        <div class='mb-3 col-10 container'>
                            ...
                            <template v-if="add_errors.job">
                                <p v-for="error in add_errors.job" class="alert alert-danger d-flex align-items-center"
                                    role="alert">
                                    {{ error }}
                                </p>
                            </template>
                        ...
                        <div class='mb-3 col-10 container'>
                            ...
                            <template v-if="add_errors.date">
                                <p v-for="error in add_errors.date" class="alert alert-danger d-flex align-items-center"
                                    role="alert">
                                    {{ error }}
                                </p>
                            </template>
